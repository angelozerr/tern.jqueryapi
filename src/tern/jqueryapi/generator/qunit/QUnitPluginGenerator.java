...
public class QUnitPluginGenerator implements tern.jqueryapi.generator.IGenerator
 {
  protected static String nl;
  public static synchronized QUnitPluginGenerator create(String lineSeparator)
  {
    nl = lineSeparator;
    QUnitPluginGenerator result = new QUnitPluginGenerator();
    nl = null;
    return result;
  }
