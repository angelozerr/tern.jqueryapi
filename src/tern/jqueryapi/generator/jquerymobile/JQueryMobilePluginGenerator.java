...
import tern.jqueryapi.generator.TernPluginOptions;

public class JQueryMobilePluginGenerator implements tern.jqueryapi.generator.IGenerator
 {
  protected static String nl;
  public static synchronized JQueryMobilePluginGenerator create(String lineSeparator)
  {
    nl = lineSeparator;
    JQueryMobilePluginGenerator result = new JQueryMobilePluginGenerator();
    nl = null;
    return result;
  }
