...
public class JQueryUIPluginGenerator implements tern.jqueryapi.generator.IGenerator
 {
  protected static String nl;
  public static synchronized JQueryUIPluginGenerator create(String lineSeparator)
  {
    nl = lineSeparator;
    JQueryUIPluginGenerator result = new JQueryUIPluginGenerator();
    nl = null;
    return result;
  }
